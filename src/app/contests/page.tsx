      ...
      <div className="border-b border-[var(--border-base)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-3xl font-extrabold text-white mb-1">All Contests</h1>
          ...
          <div className="mt-6 relative max-w-lg">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/5 border border-white/10 focus:border-indigo-500/60 focus:ring-2 focus:ring-indigo-500/20 text-white placeholder-slate-400 text-sm outline-none transition-all"
            />
            {search && (
        ...
        {filtered.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((c) => (
              ...
              >
                {/* Color bar */}
                <div className={`h-1.5 w-full bg-gradient-to-r ${c.imageColor}`} />
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-slate-400">{c.organizer.name}</span>
                    </div>
                  ...
                  {/* Title & description */}
                  <h3 className="font-bold text-white text-base mb-2 group-hover:text-indigo-300 transition-colors line-clamp-2 flex-1">
                    {c.title}
                  </h3>
                  ...
                  <div className="flex items-center gap-2 flex-wrap mb-4">
                    <span className="text-xs px-2 py-0.5 rounded-full bg-slate-800 text-slate-300">{c.category}</span>
